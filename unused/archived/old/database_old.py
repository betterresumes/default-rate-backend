...
class Organization(Base):
    ...
    name = Column(String(255), nullable=False)  # "HDFC Bank", "ICICI Bank"
    slug = Column(String(100), unique=True, nullable=False, index=True)  # "hdfc-bank", "icici-bank"
    domain = Column(String(255), nullable=True)  # "hdfc.com" (optional)
    description = Column(Text, nullable=True)
    logo_url = Column(String(500), nullable=True)
    
    # Organization settings
    is_active = Column(Boolean, default=True)
    max_users = Column(Integer, default=50)  # Future: subscription limits
    
    # Metadata - nullable to avoid circular dependency
